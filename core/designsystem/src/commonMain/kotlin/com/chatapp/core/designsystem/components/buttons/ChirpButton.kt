package com.chatapp.core.designsystem.components
...
fun ChirpButton(
    ...
    val border = when (style) {
        ChirpButtonStyle.PRIMARY if !enabled -> defaultBorderStroke
        ChirpButtonStyle.SECONDARY -> defaultBorderStroke
        ChirpButtonStyle.DESTRUCTIVE_PRIMARY if !enabled -> defaultBorderStroke
